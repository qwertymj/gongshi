...
<div class="control-group">
    ...
    <label class="col-xs-10" >
        <table class='table table-hover table-bordered' >
                <thead>
                    <tr><td style='width: 150px;'>编号</td><td style='width: 150px;'>工时数据名称</td><td style='width: 150px;'>工时数据单位</td><td style='width: 150px;'>工时数据单价</td></tr>
                </thead>
        ...
        <div class="control-group">
            <label class="control-label">工时数据新名称</label>
            <div class="controls">
                <input type="text" class="span6 m-wrap" name="workunit">
            </div>
        </div>
        <div class="control-group">
            <label class="control-label">工时数据新单位</label>
            <div class="controls">
                <input type="text" class="span6 m-wrap" name="unit_name">
            </div>
        </div>
        <div class="control-group">
            <label class="control-label">工时数据新单价</label>
            <div class="controls">
