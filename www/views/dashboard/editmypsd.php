...
<div class='row-fluid'>
    ...
    if(@$success && $success)
    {
        ?> <div class="alert alert-success">修改成功，请使用新密码重新登录！</div> <?php
    }
	...
	<form action="/dashboard/editmypsd" method='post'>
       ...
       <div class="control-group">
            ...
            <div class="controls">
                <input type="password" class="span6 m-wrap" name="newpasswd" >
            </div>
        </div>
        ...
        <div class="control-group">
            ...
            <div class="controls">
                <input type="password" class="span6 m-wrap" name="newpasswdagain" >
            </div>
        </div> 
